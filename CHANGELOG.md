...
-   **Timer-Standardisierung**: Der `vocab learn`-Befehl hat jetzt standardmäßig einen 25-Minuten-Timer zwischen den Lernsitzungen, analog zum `words`-Befehl. Eine `--test`-Option für einen 5-Sekunden-Timer wurde ebenfalls hinzugefügt.
...
-   **Benutzeroberfläche**: Die Benutzeroberfläche des Vokabel-Features wurde überarbeitet und an das konsistente, box-basierte Design der Anwendung angepasst

### ✨ Feature

-   **Visuelles Feedback**: Es wurden mehr Emojis und eine durchgängige Farbcodierung für besseres visuelles Feedback hinzugefügt
